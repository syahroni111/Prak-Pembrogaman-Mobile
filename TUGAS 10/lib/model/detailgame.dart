...
part 'detailgame.g.dart'; // Harus di-generate dengan build_runner

// Model untuk Minimum System Requirements
@JsonSerializable()
...
class DetailGame {
  ...
  // Perhatikan tanda tanya (?) untuk menangani data null
...
// JANGAN LUPA jalankan perintah: flutter pub run build_runner build